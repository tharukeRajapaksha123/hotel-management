...
import numberValidator from "./numberValidation"
...
const AddWeddingModal = ({ handleOk, handleCancel, isModalOpen, weddingData }) => {
   ...
   const createWedding = async () => {
      ...
      await axios.post(`http://localhost:8080/wedding-controller/create-wedding`
         , {
            "customer_id": "tesad",
         ...
         notification.open({
            message: 'Hey',
            description:
               'You have booked the hall succesfully.',
            onClick: () => {
